...
| 限制项 | 免费版 | 付费版（Starter）|
|--------|--------|------------------|
| 日调用次数 | 250 次/天 | 10,000+ 次/天 |
| 股票覆盖 | 主要美股（~3000只） | 全球 70,000+ 只 |
| 数据字段 | 基础价格+均线 | 完整财务数据+技术指标 |
| 实时性 | 延迟 15-30 分钟 | 实时/WS 推送 |
| 历史数据 | 有限 | 30+ 年历史 |

**免费版主要缺点：**
- 🐌 **访问频次低**：250次/天仅够刷新约80只股票
- 📉 **股票覆盖少**：仅支持主流美股，小盘股/新股缺失
- 📊 **数据不丰富**：缺少完整财报、技术指标、新闻等深度数据

### 推荐付费 API

如果免费版无法满足需求，推荐以下付费方案：

| 服务商 | 价格 | 优势 | 适用场景 |
|--------|------|------|----------|
| **[FMP Paid](https://site.financialmodelingprep.com/pricing)** | $19/月起 | 数据完整，接口统一 | 专业美股分析 |
| **[Alpha Vantage](https://www.alphavantage.co/premium/)** | $49.99/月起 | 全球覆盖，外汇+ crypto | 多资产配置 |
| **[IEX Cloud](https://iexcloud.io/pricing/)** | $19/月起 | 实时数据，低延迟 | 高频交易 |
| **[Polygon.io](https://polygon.io/pricing)** | $49/月起 | 历史数据完整 | 量化回测 |
| **[Yahoo Finance API](https://www.yahoofinanceapi.com/)** | $10/月起 | 便宜，数据丰富 | 个人投资者 |

> 💡 **建议**：个人投资者可先使用免费版验证需求，日调用超过200次后再考虑升级付费版。
